...
/** listUserInterface GET /api/userInterfaceInfo/list */
...
/** listUserInterfaceByPage GET /api/userInterfaceInfo/list/page */
export async function listUserInterfaceByPageUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listUserInterfaceByPageUsingGETParams,
  options?: { [key: string]: any },
) {
...
/** openUserInterface POST /api/userInterfaceInfo/open */
export async function openUserInterfaceUsingPost(
  body: API.UserInterfaceInfoOpenRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/userInterfaceInfo/open', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
